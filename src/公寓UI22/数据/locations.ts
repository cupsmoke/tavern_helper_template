...
export const locations: Record<string, Location[]> = {
  ...
  二丁目: [
    { name: '天神坂', description: ' ', characters: [] },
    { name: '儿童公园', description: ' ', characters: [] },
    {
      name: '宫本家',
  ...
  站前町: [
    { name: '超市', description: '一家神秘的店铺，不知道卖些什么。', characters: [] },
    { name: '健身房', description: '悠闲的午后，来一杯香浓的咖啡。', characters: [] },
    { name: '爱情旅馆', description: '书香四溢，静谧的阅读空间。', characters: [] },
  ],
  港南区: [{ name: '一番星', description: '一家神秘的店铺，不知道卖些什么。', characters: [] }],
  白鹭区: [
    { name: '圣心教堂', description: '柚坂圣心天主教堂', characters: [] },
    { name: '女子学院', description: '私立圣乌尔苏拉女子学院', characters: [] },
    { name: '观月', description: '高级料亭·观月', characters: [] },
  ],
};
